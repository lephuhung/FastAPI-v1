...
import {trangthai, donvi, ctnv, tinhchat} from '../Facebook/IFacebook'
...
const ValidateUid = Yup.object().shape({
  ...
  SDT: Yup.string().min(0,'Quá ngắn').max(11, 'Quá dài').matches(/^\d+$/, 'Số điện thoại là ký tự số, nếu không có điền 0'),
