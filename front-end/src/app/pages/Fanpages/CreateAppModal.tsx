...
import {status, unit, task, characteristic} from '../Facebook/IFacebook'
import {IFanpageModal} from './Fanpage'
...
const ValidateUid = Yup.object().shape({
  ...
  phone_number: Yup.string().min(0,'Quá ngắn').max(11, 'Quá dài').matches(/^\d+$/, 'Số điện thoại là ký tự số, nếu không có điền 0'),
            ...
            <Form>
              <div className='mb-5' style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <div style={{marginRight: '30px'}}>
                  ...
                  <MySelect width='200px' label='Job Type' name='status'>
                ...
                <div>
                  ...
                  <MySelect width='200px' label='Job Type' name='characteristic_id'>
              ...
              <div className='mb-5' style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <div>
                  ...
                  <MySelect width='200px' label='Job Type' name='task_id'>
