...
import {status, individual} from '../Individual/individual'
        ...
        <div className='card-toolbar'>
          ...
          >
            <Formik
              ...
              onSubmit={(values) => {
                instance
                  .post(`${URL}/search/individual?keyword=${values.keyword}`)
                  .then((response: any) => {
          ...
          <table className='table border gy-3 gs-3'>
            ...
            <thead>
              <tr className='fw-bold fs-6 text-gray-800 border-bottom border-gray-200'>
                ...
                <th className='min-w-50px text-center'>is_kol</th>
                  ...
                  >
                    ...
                    <td>
                      <div className='d-flex align-items-center'>
                        <div className='symbol symbol-50px me-5'>
                          {el._source.image_url ? (
                            <img src={el._source.image_url} className='' alt='' />
                          ) : (
                            <Avatar name={el._source.full_name} round={true} size='50' />
                          )}
                        </div>
                        <div className='d-flex justify-content-start flex-column'>
                          <a href='#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                            {el._source.full_name.toUpperCase()}
                          </a>
                          <span className='text-muted fw-semibold text-muted d-block fs-7'>
                            {`citizen_id/national_id: ${el._source.citizen_id}/${el._source.national_id}`}
                          </span>
                        </div>
                      </div>
                    </td>
                    <td>
                      <span className='badge badge-light-primary fs-7 fw-semibold'>{el._source.phone_number}</span>
                    </td>
                    <td>
                      <span className='badge badge-light-success fs-7 fw-semibold'>
                        {el._source.hometown.slice(0, 30)}
                      </span>
                    </td>
                    <td>
                      <span className='badge badge-primary fs-7 fw-semibold fw-semibold'>
                        {/* {el._source.unit_name} */}
                      </span>
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      <a
                        ...
                        onClick={() => {
                          axios
                            .delete(`${URL}/individual/delete/${el._source.id}`)
                            .then((res) => {
                              if (res.status === 200) {
