...
const CardItemIndividual: FC<Props> = ({
  title,
  count,
  item,
}) => {
        ...
        <div className='d-flex flex-wrap mb-1'>
          <div className='w-100 mb-5'>
            ...
            >
              ...
              <h3 className='fs-4 text-primary fw-bold mb-0 ms-4'>Công tác nghiệp vụ</h3>
            </div>
            {item.statistics &&
          ...
          <div className='w-100 mb-5'>
            ...
            >
              ...
              <h3 className='fs-4  text-primary fw-bold mb-0 ms-4'>Tính chất đối tượng</h3>
            </div>
            {item.statistics &&
          ...
          <div className='w-100'>
            ...
            >
              ...
              <h3 className='fs-4 text-primary fw-bold mb-0 ms-4'>KOL</h3>
            </div>
                  <div
                    className='border border-gray-300 border-dashed rounded min-w-100px py-3 px-4 me-6 mb-3 d-inline-block bg-light-info'
                  >
                    <div className='fw-bold fs-6 text-gray-600'>KOLS</div>
                    <div className='fw-bold fs-6 text-gray-800'>{item.statistics.kols.count}</div>
                  </div>
          </div>
        </div>
      </div>
