...
const RoleDoi: React.FC<Props> = ({className}) => {
  ...
  const {isLoading: isLoadingRolePermissions, data: rolePermissions} = useQuery({
    queryKey: ['rolePermissionsDoi'],
    queryFn: async () => {
      const response = await axios.get(`${URL}/role-permissions/roles/doi`)
  ...
  const handleUpdatePermissions = async () => {
    try {
      setIsUpdating(true)
      await axios.put(`${URL}/role-permissions/roles/doi/permissions`, {
        permission_ids: selectedPermissions,
      })
      
      // Invalidate and refetch queries
      await queryClient.invalidateQueries('rolePermissionsDoi')
