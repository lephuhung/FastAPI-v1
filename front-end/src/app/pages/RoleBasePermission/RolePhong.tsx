...
const RolePhong: React.FC<Props> = ({className}) => {
  ...
  const {isLoading: isLoadingRolePermissions, data: rolePermissions} = useQuery({
    queryKey: ['rolePermissionsPhong'],
    queryFn: async () => {
      const response = await axios.get(`${URL}/role-permissions/roles/phong`)
  ...
  const handleUpdatePermissions = async () => {
    try {
      setIsUpdating(true)
      await axios.put(`${URL}/role-permissions/roles/phong/permissions`, {
        permission_ids: selectedPermissions,
      })
      
      // Invalidate and refetch queries
      await queryClient.invalidateQueries('rolePermissionsPhong')
