...
const RoleAdmin: React.FC<Props> = ({className}) => {
  ...
  const {isLoading: isLoadingRolePermissions, data: rolePermissions} = useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get(`${URL}/role-permissions/roles/admin`)
  ...
  const handleUpdatePermissions = async () => {
    try {
      setIsUpdating(true)
      await axios.put(`${URL}/role-permissions/roles/admin/permissions`, {
        permission_ids: selectedPermissions,
      })
      
      // Invalidate and refetch queries
      await queryClient.invalidateQueries('rolePermissions')
